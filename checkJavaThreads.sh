...
# @author Jerry Lee (oldratlee@gmail.com)
# @author superhj1987 (superhj1987@126.com)
...
elif type -P jstack >/dev/null 2>&1; then
...
cleanupWhenExit() {
    rm -rf "$tmp_store_dir" >/dev/null 2>&1
}
